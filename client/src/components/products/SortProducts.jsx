...
function SortProducts({ sortBy, onSortChange }) {
    ...
    return (
        <div className="products-sorting-container">
            <label className="products-sorting-label" htmlFor="sort-select">Sort by</label>
            <select className="products-sorting" id="sort-select" value={sortBy} onChange={handleSortChange}>
